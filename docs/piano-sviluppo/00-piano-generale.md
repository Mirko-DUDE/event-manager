...
| Fase 2 | Login: Google OAuth, login locale, ruoli/permessi, sessione, activity log | 🔶 in corso (2.1–2.4, 2.8 ✅; 2.10 parziale) | `fase-2-login.md` |
...
10. Spike di test end-to-end con credenziali Google reali — 🔶 parziale (Admin Google OK in dev)

## Prossimi passi

- Prossimo passo: § 2.7 route login locale emergenza super-admin (urgente se il super-admin potrebbe fare logout) oppure § 2.5 istanza OAuth App.
