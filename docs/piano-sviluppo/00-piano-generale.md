...
2. Build container e deploy Cloud Run — 🔶 (Parte A ✅ codice; Parti B/C da fare in console GCP)
...
- **Prossimo passo**: § 3.2 Parti B/C — Secret Manager e deploy Cloud Run via wizard GitHub (console GCP).
