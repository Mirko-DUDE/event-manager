...
| Fase 2 | Login: Google OAuth, login locale, ruoli/permessi, sessione, activity log | 🔶 in corso (2.1, 2.2, 2.8 ✅) | `fase-2-login.md` |
...
- Prossimo passo: § 2.3 credenziali Google OAuth (passaggio esterno) oppure § 2.7 route login locale emergenza.
