...
- **§ 2.10 — Spike parziale (dev, 2026-08-02)**: login Google Admin OK; rifiuto utente non censito / dominio errato con messaggio generico → OK. **Non ancora verificato**: login Google App (§ 2.5), login locale App (§ 2.6), staging Cloud Run.
