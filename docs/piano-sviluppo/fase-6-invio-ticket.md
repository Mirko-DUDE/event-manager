...
- **CMS per contenuti delle pagine pubbliche** (sessione dedicata, 2026-08-20 — chiude il debito aperto il 2026-08-07): **nessun CMS in questa versione**, per entrambe le superfici pubbliche.
  ...
  - Nota: questa decisione riguarda solo la gestione editoriale dei contenuti (CMS sì/no); il design visivo (stile neutro homepage, `design-system.mdc` per la pagina biglietto) resta una sessione separata e ancora aperta.
